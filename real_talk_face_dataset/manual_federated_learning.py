...
for server_backup in server_path.iterdir():
    ...
    if os.path.exists(gatv_backup) and model_epoch != "0":
        ...
        E_server.load_state_dict(server_backup_checkpoint['E_state_dict'])
        ...
        E_gatv.load_state_dict(gatv_backup_checkpoint['E_state_dict'])
