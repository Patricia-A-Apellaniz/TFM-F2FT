...
def mountDisksServer(mount_dir_visiona1, mount_dir_visiona2):
...
# This function mounts a virtual link to a directory in other device with data
def mountDisksGatv(mount_dir_famous, mount_dir_tfg_tfm):
...
def select_training_frames(K, video_path):
    frames_paths = []
